...
public class GalleryController {
	...
	//사용중(가온)
	@PostMapping("/gallery-multiple-update")
	public @ResponseBody int updateGalleryInfoStatus(@RequestParam String data) throws Exception{
		gService.updateGalleryInfoStatus(data);
		return 1;
	}
