...
<div class="container" style="margin-top:150px; width:700px; letter-spacing:-2px;">
		...
		<!-- 일반 회원 가입 -->
		<form action="/inc/login.php" method="post" onsubmit="return snscheck();" name="join_form" id="join_form">
		<input type="hidden" name="mode" value="join">
		<input type="hidden" name="gender" value="남" id="gender">
		<input type="hidden" name="logintype" value="0">
		<input type="hidden" name="type" value="1">
		<input type="hidden" name="age" id="age" value="10">
