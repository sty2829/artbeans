	...
	xhr.onreadystatechange = function(){
		if(xhr.readyState==4 && xhr.status==200){
			...
			for(var galleryInfo of res.content){				
				...
				html += '<img style="width:400px; height:400px" src=\'/var/lib/jenkins/workspace/resources/assets/img/gallery/' +galleryInfo.fileInfo.fiPath+ '\'" class="img-fluid" onclick="location.href=\'/views/gallery/views?giNum=' + galleryInfo.giNum + '\'">';
				html += '</div>';				
